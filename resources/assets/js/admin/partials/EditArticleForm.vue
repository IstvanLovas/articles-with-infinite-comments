    ...
    export default {
        ...
        data() {
            return {
                focused: false,
                date:{
                     time: moment(this.article.published_at).format('DD-MM-YYYY')
                },
                endtime: {
                    time: ''
                },
                ...
                form: new Form({
                    ...
                    published_at: moment(this.article.published_at).format('DD-MM-YYYY'),
        ...
        methods: {
            ...
            onSubmit() {
                this.form.patch('/admin/articles/' + this.article.id, this.form)
